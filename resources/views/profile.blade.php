...
<div class="max-w-8xl mx-auto px-4 py-8 min-h-screen">
    ...
    {{-- Profile Header --}}
    <div class="bg-secondary-bg/90 backdrop-blur-sm border border-border-color rounded-lg p-6 mb-8 flex flex-col md:flex-row items-center md:items-start gap-6">
...
<div class="tab-container flex gap-6 border-b border-gray-300 mb-6">
    ...
    <div id="recommendations" class="tab-content hidden mt-8">
        @if (!empty($recommendationsByGenres))
            <section class="mb-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
