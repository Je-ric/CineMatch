...
<body class="min-h-screen font-oswald bg-no-repeat bg-cover bg-center"
    ...
    <div class="relative min-h-[calc(100vh-64px)]">
        ...
        <div class="relative z-10 flex items-center justify-center min-h-[calc(100vh-64px)] px-4">
            <div class="w-full max-w-md p-8 rounded-2xl shadow-xl bg-neutral-900/40 backdrop-blur-md border border-white/20">
                ...
                <div id="login-form-container" class="form-container">
                    ...
                    <div class="flex items-center justify-center gap-4">
                        <a href="{{ route('auth.google.redirect') }}">
                            <img src="{{ asset('img/auth/google-logo.png') }}" alt="Google" class="w-6 h-6">
                        </a>
                        <a href="{{ route('auth.facebook.redirect') }}">
                            <img src="{{ asset('img/auth/facebook-logo.png') }}" alt="Facebook" class="w-6 h-6">
                        </a>
                        <a href="{{ route('auth.github.redirect') }}">
                            <img src="{{ asset('img/auth/github-logo.png') }}" alt="GitHub" class="w-6 h-6">
                        </a>
                    </div>
