...
@section('title', 'Movie Recommendation System')
...
(function($) {
        ...
        allMovies: [
            {
                ...
                genre_ids: '1,2,3',
                genre_names: 'Action,Thriller,Sci-Fi'
            },
            {
                id: 2,
                title: 'The Shawshank Redemption',
                release_year: 1994,
                poster_url: 'https://placehold.co/300x450?text=Shawshank',
                avg_rating: 4.9,
                total_reviews: 320,
                country_name: 'United States',
                language_name: 'English',
    ...
    function initialLoad() {
        ...
        state.trending = state.allMovies.slice(0, 6);
